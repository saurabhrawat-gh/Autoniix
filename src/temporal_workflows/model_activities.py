...
from src.services.experiments.observability import upsert_model_health
...
async def check_model_drift(model_cfg: dict) -> dict:
    ...
    try:
        ...
        logger.warning("model_maintenance.drift_check_failed",
                       model=model_cfg["model_name"], error=str(e))
...
async def retrain_model(model_cfg: dict) -> dict:
    ...
    try:
        ...
        logger.error("model_maintenance.retrain_failed",
                     model=model_cfg["model_name"], error=str(e))
