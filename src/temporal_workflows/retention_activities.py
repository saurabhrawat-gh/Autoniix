...
async def list_videos_needing_retention_activity(limit: int) -> list[str]:
    ...
    from src.services.analytics.retention_fetcher import videos_needing_retention
...
async def fetch_retention_for_video_activity(content_id: str) -> dict:
    ...
    from src.services.analytics.retention_fetcher import fetch_and_store_retention
