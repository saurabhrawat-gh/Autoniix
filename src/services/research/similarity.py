...
async def store_topic_embedding(
    ...
    """, content_id, channel_id, text_type, text, emb_str, sh)
...
async def check_similarity(
    ...
    logger.info("similarity.check",
                is_dup=is_duplicate, max_sim=round(max_sim, 3),
                novelty=novelty_score, matches=len(nearest))
