...
async def extract_thumbnail_features(
    content_id: str, channel_id: str, composition: dict, variant_id: int = 0, text_overlay: str = ""
) -> dict:
    ...
    try:
        ...
        """,
            ...
            dominant_rgb,
            features["color_contrast_score"],
            features["brightness_score"],
            features["saturation_score"],
            features["rule_of_thirds_score"],
            features["text_word_count"],
            features["local_composition_score"],
            0.0,
        )
...
async def ingest_ctr_outcome(content_id: str, channel_id: str, actual_ctr: float, impressions: int) -> bool:
