...
Start with::
    ...
    python -m services_api.brain.main
...
from services_api.brain.reflector import run_reflector_loop
from services_api.brain.resolver import run_resolver_loop
from services_api.brain.scorer import run_scorer_loop
