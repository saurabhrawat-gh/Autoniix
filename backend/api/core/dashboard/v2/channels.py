...
async def get_channel_brand_kit(
    ...
    from services_api.brand.brand_kit_resolver import resolve_brand_kit_for_channel
...
async def put_channel_brand_kit(
    ...
    from services_api.brand.brand_kit_resolver import bind_channel_brand_kit
