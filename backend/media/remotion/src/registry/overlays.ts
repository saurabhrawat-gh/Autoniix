...
export const OVERLAY_PRESETS: PresetRegistry = {
  ...
  "ov.progress.segmented_top": {
    ...
    category: "overlay",
    tags: ["progress", "chapters"],
  },

  "ov.particles.dust": {
    id: "ov.particles.dust",
    component: Particles,
    defaultProps: { style: "dust" },
    category: "overlay",
    tags: ["particles", "ambient"],
  },
  "ov.particles.snow": {
    id: "ov.particles.snow",
    component: Particles,
    defaultProps: { style: "snow" },
    category: "overlay",
    tags: ["particles", "weather"],
  },
  "ov.particles.sparkles": {
    id: "ov.particles.sparkles",
    component: Particles,
    defaultProps: { style: "sparkles" },
    category: "overlay",
    tags: ["particles", "magic"],
  },
  "ov.particles.confetti": {
    id: "ov.particles.confetti",
    component: Particles,
    defaultProps: { style: "confetti" },
    category: "overlay",
  ...
  "ov.subscribe.neon": {
    id: "ov.subscribe.neon",
    component: SubscribePing,
    defaultProps: { style: "neon", text: "SUBSCRIBE", position: "br" },
    category: "overlay",
    tags: ["subscribe", "cta", "neon"],
  },

  "ov.endcard.default": {
    id: "ov.endcard.default",
    component: EndCard,
    defaultProps: {},
    category: "overlay",
    tags: ["endcard", "cta"],
  ...
  "ov.chapter.bottom_left": {
    id: "ov.chapter.bottom_left",
    component: ChapterMarker,
    defaultProps: { position: "bottom" },
    category: "overlay",
    tags: ["chapter"],
  },

  "ov.wordcap.karaoke_yellow": {
    id: "ov.wordcap.karaoke_yellow",
    component: WordAlignedCaption,
    defaultProps: {
    ...
    category: "overlay",
    tags: ["caption", "word-level", "premium"],
  },
  "ov.wordcap.karaoke_cyan": {
    id: "ov.wordcap.karaoke_cyan",
    component: WordAlignedCaption,
    defaultProps: {
      style: "karaoke_highlight",
      activeColor: "#00E0FF",
  ...
  "ov.wordcap.pop_shorts": {
    ...
    category: "overlay",
    tags: ["caption", "word-level", "shorts", "premium"],
  },
  "ov.wordcap.underline_minimal": {
    id: "ov.wordcap.underline_minimal",
    component: WordAlignedCaption,
    defaultProps: {
      style: "underline_active",
      activeColor: "#FF3B30",
      chunkSize: 8,
      position: "bottom",
    },
    category: "overlay",
    tags: ["caption", "word-level", "minimal", "premium"],
  },

  "ov.waveform.bars_bottom": {
    id: "ov.waveform.bars_bottom",
    ...
    category: "overlay",
    tags: ["audio", "waveform", "premium", "bars"],
  },
  "ov.waveform.circular": {
    id: "ov.waveform.circular",
    component: AudioWaveform,
    defaultProps: { audioSrc: "", style: "circular", bars: 48, color: "#FF3B30", height: 0.3 },
    category: "overlay",
    tags: ["audio", "waveform", "premium", "circular"],
  },
  "ov.waveform.line_center": {
    id: "ov.waveform.line_center",
    component: AudioWaveform,
    defaultProps: {
      audioSrc: "",
      style: "line",
    ...
    category: "overlay",
    tags: ["audio", "waveform", "premium", "line"],
  },
  "ov.waveform.radial": {
    id: "ov.waveform.radial",
    component: AudioWaveform,
    defaultProps: { audioSrc: "", style: "radial", bars: 64, color: "#4ECDC4", height: 0.4 },
    category: "overlay",
    tags: ["audio", "waveform", "premium", "radial"],
  },

  "ov.lowerthird.premium.minimal": {
    id: "ov.lowerthird.premium.minimal",
    component: PremiumLowerThird,
    defaultProps: {
      variation: "minimal",
      name: "John Doe",
    ...
    category: "overlay",
    tags: ["lowerthird", "premium", "100%", "minimal", "broadcast"],
  },
  "ov.lowerthird.premium.corporate": {
    id: "ov.lowerthird.premium.corporate",
    component: PremiumLowerThird,
    defaultProps: {
      variation: "corporate",
      name: "Jane Smith",
    ...
    category: "overlay",
    tags: ["lowerthird", "premium", "100%", "corporate", "broadcast"],
  },
  "ov.lowerthird.premium.modern": {
    id: "ov.lowerthird.premium.modern",
    component: PremiumLowerThird,
    defaultProps: {
      variation: "modern",
      name: "Alex Johnson",
    ...
    category: "overlay",
    tags: ["lowerthird", "premium", "100%", "modern", "broadcast"],
  },
  "ov.lowerthird.premium.bold": {
    id: "ov.lowerthird.premium.bold",
    component: PremiumLowerThird,
    defaultProps: {
      variation: "bold",
      name: "Sarah Williams",
    ...
    category: "overlay",
    tags: ["lowerthird", "premium", "100%", "bold", "broadcast"],
  },
  "ov.lowerthird.premium.elegant": {
    id: "ov.lowerthird.premium.elegant",
    component: PremiumLowerThird,
    defaultProps: {
      variation: "elegant",
      name: "Michael Brown",
    ...
    category: "overlay",
    tags: ["lowerthird", "premium", "100%", "elegant", "broadcast"],
  },

  "ov.logo.3d.flip": {
    id: "ov.logo.3d.flip",
    component: ThreeDLogoReveal,
    defaultProps: { logoSrc: "", animation: "flip", duration: 90, size: 0.4, color: "#4ECDC4" },
    category: "overlay",
    tags: ["logo", "3d", "premium", "95%", "flip", "reveal"],
  },
  "ov.logo.3d.cube": {
    id: "ov.logo.3d.cube",
    component: ThreeDLogoReveal,
    ...
    category: "overlay",
    tags: ["logo", "3d", "premium", "95%", "cube", "reveal"],
  },
  "ov.logo.3d.fold": {
    id: "ov.logo.3d.fold",
    component: ThreeDLogoReveal,
    ...
    category: "overlay",
    tags: ["logo", "3d", "premium", "95%", "fold", "reveal"],
  },
  "ov.logo.3d.explode": {
    id: "ov.logo.3d.explode",
    component: ThreeDLogoReveal,
    defaultProps: { logoSrc: "", animation: "explode", duration: 120, size: 0.4, color: "#fa709a" },
    category: "overlay",
    tags: ["logo", "3d", "premium", "95%", "explode", "reveal"],
  },
  "ov.logo.3d.spiral": {
    id: "ov.logo.3d.spiral",
    component: ThreeDLogoReveal,
    defaultProps: { logoSrc: "", animation: "spiral", duration: 90, size: 0.4, color: "#FFD700" },
    category: "overlay",
    tags: ["logo", "3d", "premium", "95%", "spiral", "reveal"],
  },
  "ov.logo.3d.particles": {
    id: "ov.logo.3d.particles",
    component: ThreeDLogoReveal,
    defaultProps: {
      logoSrc: "",
      animation: "particles",
    ...
    category: "overlay",
    tags: ["logo", "3d", "premium", "95%", "particles", "reveal"],
  },
};
