...
export const SCENE_PRESETS: PresetRegistry = {
  ...
  "scene.data.donut": {
    id: "scene.data.donut",
    component: DataVisualization,
    defaultProps: { type: "donut" },
    category: "scene",
    tags: ["data", "chart", "donut"],
  },
  "scene.data.stacked_bar": {
    id: "scene.data.stacked_bar",
    component: DataVisualization,
    defaultProps: { type: "stacked_bar" },
    category: "scene",
    tags: ["data", "chart"],
  },

  "scene.split.vs_badge": {
    id: "scene.split.vs_badge",
    component: SplitComparison,
    defaultProps: { vsBadge: true },
    category: "scene",
    tags: ["split", "compare", "vs"],
  },
  "scene.split.no_badge": {
    id: "scene.split.no_badge",
    component: SplitComparison,
    defaultProps: { vsBadge: false },
    category: "scene",
    tags: ["split", "compare"],
  },
  ...
  "scene.icon.pulse": {
    id: "scene.icon.pulse",
    component: IconAnimation,
    defaultProps: { style: "pulse" },
    category: "scene",
    tags: ["icon", "pulse"],
  },

  "scene.countdown.numeric": {
    id: "scene.countdown.numeric",
    component: CountdownScene,
    defaultProps: { style: "numeric" },
    category: "scene",
    tags: ["countdown"],
  },
  "scene.countdown.dial": {
    id: "scene.countdown.dial",
    component: CountdownScene,
    defaultProps: { style: "dial" },
    category: "scene",
    tags: ["countdown", "dial"],
  },

  "scene.beforeafter.auto_sweep": {
    id: "scene.beforeafter.auto_sweep",
    component: BeforeAfterSlider,
    defaultProps: { mode: "auto" },
    category: "scene",
    tags: ["beforeafter", "slider"],
  },
  "scene.beforeafter.static_center": {
    id: "scene.beforeafter.static_center",
    component: BeforeAfterSlider,
    defaultProps: { mode: "static", position: 0.5 },
    category: "scene",
    tags: ["beforeafter"],
  },

  "scene.mockup.phone_iphone": {
    id: "scene.mockup.phone_iphone",
    component: PhoneMockup,
    defaultProps: { style: "iphone" },
    category: "scene",
    tags: ["mockup", "phone"],
  },
  "scene.mockup.phone_tilted": {
    id: "scene.mockup.phone_tilted",
    component: PhoneMockup,
    defaultProps: { style: "iphone", tilt: -8 },
    category: "scene",
    tags: ["mockup", "phone"],
  },
  "scene.mockup.browser": {
    id: "scene.mockup.browser",
  ...
  "scene.mockup.social_twitter": {
    id: "scene.mockup.social_twitter",
    component: SocialMockup,
    defaultProps: { platform: "twitter" },
    category: "scene",
    tags: ["mockup", "social"],
  },
  "scene.mockup.social_instagram": {
    id: "scene.mockup.social_instagram",
    component: SocialMockup,
  ...
  "scene.mockup.social_youtube_comment": {
    id: "scene.mockup.social_youtube_comment",
    component: SocialMockup,
    defaultProps: { platform: "youtube_comment" },
    category: "scene",
    tags: ["mockup", "social"],
  },

  "scene.branding.intro_sweep": {
    id: "scene.branding.intro_sweep",
  ...
  "scene.branding.outro_subscribe": {
    id: "scene.branding.outro_subscribe",
  ...
  "scene.text.stroke_reveal": {
    ...
    category: "scene",
    tags: ["text", "stroke", "premium", "reveal"],
  },
  "scene.text.stroke_reveal_neon": {
    id: "scene.text.stroke_reveal_neon",
    component: TextStrokeReveal,
    defaultProps: {
      text: "",
      fontSize: 100,
