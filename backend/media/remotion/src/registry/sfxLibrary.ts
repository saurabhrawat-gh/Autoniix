...
export const SFX_LIBRARY: Record<string, SfxEntry> = Object.fromEntries(
  [
    mk("sfx.whoosh.short", "whoosh", "Whoosh short", 300, "whoosh/whoosh_short.mp3", [
      "transition",
    ]),
    ...
    mk(
      "sfx.cinematic.reverse_hit",
      "cinematic",
      "Reverse hit",
      1400,
      "cinematic/cine_reverse_hit.mp3",
    ),
    mk(
      "sfx.cinematic.hit_rumble",
      "cinematic",
      "Hit + rumble",
      2000,
      "cinematic/cine_hit_rumble.mp3",
    ),
    mk(
      "sfx.cinematic.suspense",
      "cinematic",
      "Suspense drone",
      4000,
      "cinematic/cine_suspense.mp3",
    ),
    mk("sfx.cinematic.brass_hit", "cinematic", "Brass hit", 1200, "cinematic/cine_brass_hit.mp3"),
    mk(
      "sfx.cinematic.impact_low",
      "cinematic",
      "Low impact",
      1500,
      "cinematic/cine_impact_low.mp3",
    ),
    ...
    mk(
      "sfx.notification.message",
      "notification",
      "Message",
      600,
      "notification/notif_message.mp3",
    ),
...
export function resolveSfx(
  ...
  const base = opts.baseUrl ?? process.env.SFX_BASE_URL ?? "";
  const resolvedUrl =
    override ??
    entry.url ??
...
const ENVATO_SFX: SfxEntry[] = [
  ...mkBatch("whoosh_cinematic", "whoosh", "Envato Cinematic Whoosh", 50, 500, "envato", [
    "cinematic",
    "transition",
    "premium",
  ]),
  ...mkBatch("whoosh_soft", "whoosh", "Envato Soft Whoosh", 25, 400, "envato", [
    "soft",
    "transition",
    "premium",
  ]),
  ...mkBatch("whoosh_heavy", "whoosh", "Envato Heavy Whoosh", 25, 700, "envato", [
    "heavy",
    "transition",
    "premium",
  ]),

  ...mkBatch("impact_cinematic", "impact", "Envato Cinematic Impact", 30, 1000, "envato", [
    "cinematic",
    "premium",
  ]),
  ...mkBatch("impact_deep_bass", "impact", "Envato Deep Bass Impact", 25, 1200, "envato", [
    "bass",
    "deep",
    "premium",
  ]),
  ...mkBatch("impact_metal", "impact", "Envato Metal Impact", 25, 600, "envato", [
    "metal",
    "premium",
  ]),

  ...mkBatch("ui_click", "ui", "Envato UI Click", 20, 100, "envato", [
    "click",
    "interface",
    "premium",
  ]),
  ...mkBatch("ui_notification", "ui", "Envato Notification", 15, 500, "envato", [
    "notification",
    "premium",
  ]),
  ...mkBatch("ui_pop", "ui", "Envato UI Pop", 15, 150, "envato", ["pop", "interface", "premium"]),

  ...mkBatch("trans_riser", "transition", "Envato Riser", 30, 2500, "envato", [
    "riser",
    "build",
    "premium",
  ]),
  ...mkBatch("trans_downer", "transition", "Envato Downer", 20, 1800, "envato", [
    "downer",
    "drop",
    "premium",
  ]),
  ...mkBatch("trans_stinger", "transition", "Envato Stinger", 20, 800, "envato", [
    "stinger",
    "hit",
    "premium",
  ]),
  ...mkBatch("trans_swoosh", "transition", "Envato Swoosh", 20, 450, "envato", [
    "swoosh",
    "premium",
  ]),
  ...
  ...mkBatch(
    "amb_nature",
    "ambient",
    "Envato Nature Ambience",
    10,
    8000,
    "envato",
    ["nature", "outdoor", "premium"],
    -18,
  ),
  ...mkBatch(
    "amb_city",
    "ambient",
    "Envato City Ambience",
    10,
    8000,
    "envato",
    ["city", "urban", "premium"],
  ...
  ...mkBatch(
    "amb_interior",
    "ambient",
    "Envato Interior Ambience",
    10,
    6000,
    "envato",
    ["interior", "room", "premium"],
    -18,
  ),
  ...mkBatch(
    "amb_scifi",
    "ambient",
    "Envato Sci-Fi Ambience",
    10,
    6000,
    "envato",
    ["scifi", "futuristic", "premium"],
    -18,
  ),

  ...mkBatch("cine_boom", "cinematic", "Envato Cinematic Boom", 15, 1800, "envato", [
    "boom",
    "trailer",
    "premium",
  ]),
  ...mkBatch(
    "cine_suspense",
    "cinematic",
    "Envato Suspense Drone",
    10,
    5000,
    "envato",
    ["suspense", "drone", "premium"],
    -12,
  ),
  ...mkBatch("cine_brass", "cinematic", "Envato Brass Hit", 15, 1200, "envato", [
    "brass",
    "orchestra",
    "premium",
  ]),

  ...mkBatch("foley_step", "foley", "Envato Footstep", 10, 300, "envato", [
    "footstep",
    "walk",
    "premium",
  ]),
  ...mkBatch("foley_fabric", "foley", "Envato Fabric Rustle", 10, 400, "envato", [
    "fabric",
    "cloth",
    "premium",
  ]),
  ...mkBatch("foley_paper", "foley", "Envato Paper", 10, 350, "envato", [
    "paper",
    "page",
    "premium",
  ]),

  ...mkBatch("glitch_digital", "glitch", "Envato Digital Glitch", 15, 350, "envato", [
    "digital",
    "error",
    "premium",
  ]),
  ...mkBatch("glitch_data", "glitch", "Envato Data Corrupt", 15, 500, "envato", [
    "data",
    "corrupt",
    "premium",
  ]),

  ...mkBatch("tech_beep", "tech", "Envato Tech Beep", 10, 200, "envato", [
    "beep",
    "computer",
    "premium",
  ]),
  ...mkBatch("tech_hud", "tech", "Envato HUD Sound", 10, 400, "envato", [
    "hud",
    "interface",
    "premium",
  ]),

  ...mkBatch("explosion_big", "explosion", "Envato Big Explosion", 15, 2000, "envato", [
    "big",
    "fire",
    "premium",
  ]),
  ...mkBatch("explosion_small", "explosion", "Envato Small Explosion", 15, 800, "envato", [
    "small",
    "burst",
    "premium",
  ]),

  ...mkBatch("magic_spell", "magic", "Envato Magic Spell", 15, 1200, "envato", [
    "spell",
    "fantasy",
    "premium",
  ]),
  ...mkBatch("magic_shimmer", "magic", "Envato Shimmer", 15, 900, "envato", [
    "shimmer",
    "sparkle",
    "premium",
  ]),

  ...mkBatch("musical_piano", "musical", "Envato Piano Note", 10, 1500, "envato", [
    "piano",
    "note",
    "premium",
  ]),
  ...mkBatch("musical_guitar", "musical", "Envato Guitar Strum", 10, 1000, "envato", [
    "guitar",
    "strum",
    "premium",
  ]),

  ...mkBatch("ding_bright", "ding", "Envato Bright Ding", 10, 600, "envato", [
    "bright",
    "success",
    "premium",
  ]),
  ...mkBatch("ding_subtle", "ding", "Envato Subtle Ding", 10, 400, "envato", [
    "subtle",
    "soft",
    "premium",
  ]),

  ...mkBatch("comedy_cartoon", "comedy", "Envato Cartoon SFX", 10, 500, "envato", [
    "cartoon",
    "funny",
    "premium",
  ]),
  ...mkBatch("comedy_boing", "comedy", "Envato Boing", 10, 400, "envato", [
    "boing",
    "spring",
    "premium",
  ]),

  ...mkBatch("horror_scare", "horror", "Envato Scare Stinger", 10, 1200, "envato", [
    "scare",
    "tension",
    "premium",
  ]),
  ...
  ...mkBatch("mech_servo", "mechanical", "Envato Servo", 10, 600, "envato", [
    "servo",
    "robot",
    "premium",
  ]),
  ...mkBatch("mech_gear", "mechanical", "Envato Gear Turn", 10, 500, "envato", [
    "gear",
    "machine",
    "premium",
  ]),

  ...mkBatch("vocal_breath", "vocal", "Envato Breath", 5, 800, "envato", [
    "breath",
    "human",
    "premium",
  ]),
  ...mkBatch("vocal_crowd", "vocal", "Envato Crowd", 5, 3000, "envato", [
    "crowd",
    "people",
    "premium",
  ]),

  ...mkBatch("alarm_siren", "alarm", "Envato Siren", 5, 2000, "envato", [
    "siren",
    "warning",
    "premium",
  ]),
  ...mkBatch("alarm_beep", "alarm", "Envato Alarm Beep", 5, 1000, "envato", [
    "beep",
    "alert",
    "premium",
  ]),

  ...mkBatch("nature_thunder", "nature", "Envato Thunder", 10, 3000, "envato", [
    "thunder",
    "storm",
    "premium",
  ]),
  ...mkBatch("nature_water", "nature", "Envato Water", 10, 2000, "envato", [
    "water",
    "splash",
    "premium",
  ]),
