...
const KEYWORDS = new Set([
  ...
  "class", "interface", "type", "import", "export", "from", "as", "new",
  "await", "async", "try", "catch", "finally", "throw", "switch", "case",
  "break", "continue", "def", "lambda", "pass", "self", "null", "undefined",
  "true", "false", "nil", "None", "True", "False", "package", "func", "struct",
]);
