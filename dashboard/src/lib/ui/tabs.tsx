...
>(({ className, ...props }, ref) => (
  <TabsPrimitive.List
    ref={ref}
    className={cn(
      'inline-flex h-9 items-center justify-start rounded-lg bg-surface-2 p-1 text-content-tertiary gap-0.5',
      className
    )}
    {...props}
  />
...
>(({ className, ...props }, ref) => (
  <TabsPrimitive.Trigger
    ...
    className={cn(
      ...
      'data-[state=active]:bg-surface-0 data-[state=active]:text-content-primary data-[state=active]:shadow-card',
