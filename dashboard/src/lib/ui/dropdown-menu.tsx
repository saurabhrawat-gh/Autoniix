...
const menuItem =
  ...
  'transition-colors focus:bg-surface-2 focus:text-content-primary ' +
...
>(({ className, inset, children, ...props }, ref) => (
  <DropdownMenuPrimitive.SubTrigger
    ref={ref}
    className={cn(menuItem, inset && 'pl-8', 'data-[state=open]:bg-surface-2', className)}
    {...props}
  >
    {children}
...
>(({ className, inset, destructive, ...props }, ref) => (
  <DropdownMenuPrimitive.Item
    ...
    className={cn(
      menuItem,
      inset && 'pl-8',
      destructive && 'text-status-error focus:bg-status-error/10 focus:text-status-error',
      className
    )}
    {...props}
  />
...
>(({ className, inset, ...props }, ref) => (
  <DropdownMenuPrimitive.Label
    ref={ref}
    className={cn(
      'px-2 py-1.5 text-xs font-semibold uppercase tracking-wider text-content-tertiary',
      inset && 'pl-8',
      className
    )}
    {...props}
