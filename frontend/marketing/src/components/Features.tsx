...
const FEATURES = [
  {
    ...
    description:
      "Gemini 2.5 Flash + GPT-4o synthesise trending topics, analyse audience signals, and surface high-potential ideas — before your competition knows they exist.",
    accent: "#00D89F",
  ...
  },
  {
    ...
    description:
      "Claude Sonnet crafts cinematic, retention-optimised scripts tailored to each niche. Fact-checked, quality-scored, hook-first — ready for production.",
    accent: "#7C3AED",
  ...
  },
  {
    ...
    description:
      "Each content profile gets a unique AI voice via Fish Audio — consistent, compelling, broadcast-ready narration at a fraction of the cost.",
    accent: "#06B6D4",
  ...
  },
  {
    ...
    description:
      "Remotion-powered engine with 48+ cinematic components. Code-driven composition means zero variability — the same professional output at any volume.",
    accent: "#F59E0B",
  ...
  },
  {
    ...
    description:
      "Real-time performance signals feed back into the research loop — the AI knows what works and adjusts every topic, angle, and format automatically.",
    accent: "#2563EB",
  ...
  },
  {
    ...
    description:
      "Run unlimited YouTube channels — Shorts and long-form — from a single Autoniix setup. Zero extra effort per channel.",
    accent: "#00D89F",
          ...
          <div className="flex items-center gap-2 flex-shrink-0">
            <div className="w-16 h-1 bg-white/[0.06] rounded-full overflow-hidden">
              <div
                ...
                style={{ width: `${t.score}%`, background: accent }}
              />
            </div>
  ...
  return (
    <div>
      ...
      <svg viewBox={`0 0 ${w} ${h + 8}`} className="w-full" fill="none">
        ...
        <polyline points={pts} stroke={accent} strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" />
        {points.map((v, i) => (
          <circle
            key={i}
...
function ScaleVisual({ accent }: { accent: string }) {
  ...
  return (
    <div>
      <div className="text-[10px] font-mono text-white/30 uppercase tracking-widest mb-4">
        Active YouTube channels · 6 niches
      </div>
              ...
              return (
                ...
                >
                  ...
                  >
                    ...
                    >
                      <div className="rounded-[15px] p-6" style={{ background: "var(--bg-card-elevated)" }}>
          ...
          return (
            ...
            >
              <div className="flex items-center gap-3 mb-4">
                ...
                <div>
                  <p className="t-headline" style={{ color: "var(--text-primary)", fontSize: "0.95rem" }}>
                    {feature.title}
                  </p>
                  <p className="t-micro" style={{ color: feature.accent }}>
                    {feature.subtitle}
                  </p>
                </div>
              </div>
