...
const JOB_POOL = [
  ...
  {
    title: "Sleep cycles decoded — the science",
    niche: "Health",
  ...
  {
    title: "Gut microbiome — beginner guide",
    niche: "Health",
  ...
  {
    title: "Cold exposure — full protocol",
    niche: "Health",
    stage: "Script generation",
    color: "#7C3AED",
    progress: 31,
          ...
          <div className="flex items-center gap-2">
            <div className="flex-1 h-1 bg-white/[0.06] rounded-full overflow-hidden">
              <div
                ...
                style={{
                  width: `${job.progress}%`,
                  background: `linear-gradient(90deg, ${job.color}cc, ${job.color})`,
                }}
              />
            </div>
            <span className="text-white/35 text-[10px] font-mono flex-shrink-0 w-16 text-right">{job.stage}</span>
            <span style={{ color: job.color }} className="text-[10px] font-mono flex-shrink-0 w-8 text-right">
              {job.progress}%
            </span>
          </div>
        </motion.div>
    ...
    >
      ...
      <div className="relative z-10 max-w-7xl mx-auto px-6 pt-28 pb-12 w-full">
        ...
        >
          ...
          <GlowButton variant="ghost" size="lg" className="flex items-center gap-2 min-w-[160px] justify-center">
            See how it works
          </GlowButton>
        </motion.div>
          ...
          <div className="hero-particle-card mockup-dark relative">
            ...
            <div className="hero-particle-card-inner">
              ...
              <p className="t-body-lg max-w-md mb-6" style={{ color: "rgba(255,255,255,0.62)" }}>
                Gemini, Claude, GPT-4, ElevenLabs, Veo, FFmpeg — orchestrated together so every step of the pipeline
                gets the model best suited for it.
              </p>
