  ...
  return (
    <div className="flex items-center justify-center min-h-screen relative">
      ...
      <div className="w-full max-w-md px-6">
            ...
            {step === "credentials" ? (
              <form onSubmit={credForm.handleSubmit(handleCredentials)} className="space-y-6">
                ...
                <FormField id="password" label="Password" required error={credForm.formState.errors.password}>
                  ...
                  <Input id="password" type="password" placeholder="••••••••" {...credForm.register("password")} />
                </FormField>
        ...
        <p className="text-center text-xs text-content-tertiary mt-6">YouTube Automation Dashboard v1.0</p>
      </div>
    </div>
  );
}
