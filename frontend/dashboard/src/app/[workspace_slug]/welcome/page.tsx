    ...
    <div className="min-h-screen bg-surface-bg flex items-center justify-center px-4 py-12">
      <div className="w-full max-w-onboarding">
        ...
        <div className="flex justify-center mb-8">
          <span className="text-h3 font-semibold tracking-tight text-content-primary">
            autoniix
          </span>
        </div>
                ...
                <React.Fragment key={s.id}>
                  <button
                    ...
                    className={cn(
                      ...
                      active ? 'text-accent' :
                      done   ? 'text-content-secondary hover:text-content-primary cursor-pointer' :
          ...
          <div className="px-8 pb-8 pt-5">
            ...
            {step === 1 && (
              <StepShell
                ...
                subtitle="Your private AI content factory."
              >
                <Input
            ...
            {step === 2 && (
              <StepShell
                ...
                subtitle="How should teammates know you?"
              >
            ...
            {step === 3 && (
              <StepShell
                ...
                subtitle="Link your channel to start automating content."
              >
                <Button
                  size="lg"
                  className="w-full"
            ...
            {step === 4 && (
              ...
              >
                ...
                <ul className="space-y-2 text-sm text-content-secondary">
                  {[
                    'Workspace created',
                    displayName ? 'Profile set up' : null,
                  ]
                    .filter(Boolean)
                    .map((item) => (
        ...
        {encryptedUserId && (
          <input type="hidden" name="u" value={encryptedUserId} />
        )}
