    ...
    <main className="flex-1 px-4 sm:px-6 py-6 max-w-[1400px] mx-auto w-full">
      <div className="space-y-5">
        ...
        <p className="text-sm opacity-70">
          Centralized view of recent failures, fleet health, and notification deliveries. Wire <code>SENTRY_DSN</code>{" "}
          for the full debugger experience.
        </p>
