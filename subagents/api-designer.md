...
- `docs/architecture/02-SERVICE-CONTRACTS.md` — Existing API contracts and common envelope
...
```json
{
  ...
  "implementation_notes": [
    ...
    "Follow common response envelope from docs/architecture/02-SERVICE-CONTRACTS.md"
  ]
}
```
