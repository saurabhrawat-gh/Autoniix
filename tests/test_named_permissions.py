...
class TestPermissionCache:
    ...
    async def test_cache_miss_loads_from_db(self):
        ...
        with patch("services_api.dashboard.v2._permissions.get_pool", return_value=AsyncMock(return_value=mock_pool)):
            pm._cache.clear()
...
class TestRequirePermission:
    ...
    async def test_permission_granted(self):
        ...
        with patch("services_api.dashboard.v2._deps.principal_dep", return_value=principal):
