...
const (
	AuthService_SignIn_FullMethodName         = "/autoniix.gateway.v1.AuthService/SignIn"
	AuthService_SignUp_FullMethodName         = "/autoniix.gateway.v1.AuthService/SignUp"
	AuthService_RefreshToken_FullMethodName   = "/autoniix.gateway.v1.AuthService/RefreshToken"
	AuthService_SignOut_FullMethodName        = "/autoniix.gateway.v1.AuthService/SignOut"
	AuthService_VerifyToken_FullMethodName    = "/autoniix.gateway.v1.AuthService/VerifyToken"
	AuthService_GetCurrentUser_FullMethodName = "/autoniix.gateway.v1.AuthService/GetCurrentUser"
)
...
type AuthServiceClient interface {
	...
	GetCurrentUser(ctx context.Context, in *v1.Empty, opts ...grpc.CallOption) (*GetCurrentUserResponse, error)
}
...
func (c *authServiceClient) SignOut(ctx context.Context, in *SignOutRequest, opts ...grpc.CallOption) (*v1.Empty, error) {
	cOpts := append([]grpc.CallOption{grpc.StaticMethod()}, opts...)
	out := new(v1.Empty)
...
func (c *authServiceClient) GetCurrentUser(ctx context.Context, in *v1.Empty, opts ...grpc.CallOption) (*GetCurrentUserResponse, error) {
	cOpts := append([]grpc.CallOption{grpc.StaticMethod()}, opts...)
...
type AuthServiceServer interface {
	...
	GetCurrentUser(context.Context, *v1.Empty) (*GetCurrentUserResponse, error)
...
func (UnimplementedAuthServiceServer) SignOut(context.Context, *SignOutRequest) (*v1.Empty, error) {
...
func (UnimplementedAuthServiceServer) GetCurrentUser(context.Context, *v1.Empty) (*GetCurrentUserResponse, error) {
...
func _AuthService_GetCurrentUser_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(AuthServiceServer).GetCurrentUser(ctx, req.(*v1.Empty))
	}
	return interceptor(ctx, in, info, handler)
}
...
var AuthService_ServiceDesc = grpc.ServiceDesc{
	ServiceName: "autoniix.gateway.v1.AuthService",
	...
	Metadata: "autoniix/gateway/v1/auth.proto",
}
