...
SPRINTS = [
    ...
    (
        ...
        [
            ...
            "IM-171",
            "IM-172",
            "IM-173",  # bugs: rate-limit, timing-attack, FK orphan
            "IM-180",
            "IM-181",
            "IM-182",
            "IM-183",  # workspace deletion: cascade endpoint, grace period, member notify, orphaned user
        ],
    ),
    (
        "Core 2: Rust Gateway",
...
for name, issues in SPRINTS:
    ...
    if not sprint:
        print("  ⚠️  Skipped (creation failed)")
        continue
