...
check_pkg "apps/marketing/package.json"
...
contains "services/gateway/Dockerfile"          "RUST_IMAGE=rust:$RUST_VERSION-bookworm"       "gateway rust image"
contains "services/gateway/Dockerfile"          "DEBIAN_IMAGE=debian:bookworm-slim"            "gateway debian image"
contains "services/gateway/Dockerfile"          "COPY rust-toolchain.toml"                     "gateway copies rust-toolchain.toml"
contains "apps/dashboard/Dockerfile"            "NODE_ALPINE_IMAGE=node:$NODE_VERSION-alpine"  "dashboard node-alpine"
contains "apps/marketing/Dockerfile"            "NODE_ALPINE_IMAGE=node:$NODE_VERSION-alpine"  "marketing node-alpine"
