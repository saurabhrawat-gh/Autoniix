...
def drop_merges(row):
    ...
    to_drop = [str(mc) for mc in ws.merged_cells.ranges if mc.min_row <= row <= mc.max_row]
    for ref in to_drop:
...
# ════════════════════════════════════════════════════════════════════════════
full_merge(1, "Working History Sheet of Sh. Iqbal Chand, MCM/WM", size=14, bold=True)
ws.row_dimensions[1].height = 24

# ════════════════════════════════════════════════════════════════════════════
# ROW 2 — DOB / DOA / DOS / DOR: single merged banner
# ════════════════════════════════════════════════════════════════════════════
full_merge(2, "DOB:- 23.06.1966          DOA:- 12.06.1986          DOS:- 23.12.93          DOR:- 30.06.2026", size=11)
ws.row_dimensions[2].height = 18

# ════════════════════════════════════════════════════════════════════════════
# ROW 3 — PF No. / Bill Unit: single merged banner
# ════════════════════════════════════════════════════════════════════════════
full_merge(3, "PF No. 50300516363                    Bill Unit= 0301-268", size=11, halign="left")
